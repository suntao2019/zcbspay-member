...
public  class PojoMember implements Serializable {
    ...
    @Type(type = "com.zcbspay.platform.member.individual.pojo.usertype.RealNameLvSqlType")
    ...
    @Type(type = "com.zcbspay.platform.member.individual.pojo.usertype.MemberSqlType")
    ...
    @Type(type = "com.zcbspay.platform.member.individual.pojo.usertype.MemberStatusSqlType")
    @Column(name = "STATUS")
